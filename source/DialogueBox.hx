...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		bgFade = new FlxSprite(-200, -200).makeGraphic(1, 1);
		...
		switch (PlayState.SONG.song.toLowerCase())
		{
			...
			case 'thorns':
				...
				var face:FlxSprite = new FlxSprite(320, 170).loadGraphic(Paths.getGraphic(Paths.image('weeb/spiritFaceForward', 'week6')));
		...
		handSelect = new FlxSprite(1042, 590).loadGraphic(Paths.getGraphic(Paths.image('weeb/pixelUI/hand_textbox', 'week6')));
